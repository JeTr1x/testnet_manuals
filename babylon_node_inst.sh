...
sed -i -e "s%^address = \"tcp://localhost:1317\"%address = \"tcp://0.0.0.0:${BABYLON_PORT}917\"%; s%^address = \":8080\"%address = \":${BABYLON_PORT}980\"%; s%^address = \"0.0.0.0:9090\"%address = \"0.0.0.0:${BABYLON_PORT}990\"%; s%^address = \"0.0.0.0:9091\"%address = \"0.0.0.0:${BABYLON_PORT}991\"%; s%:8545%:${BABYLON_PORT}945%; s%:8546%:${BABYLON_PORT}946%; s%:6065%:${BABYLON_PORT}965%" $HOME/.babylond/config/app.toml
...
babylond config set client chain-id bbn-test-5
babylond config set client node tcp://localhost:${BABYLON_PORT}657
