...
# set vars
if [ ! $DEF_NODENAME ]; then
	read -p "Enter node name: " DEF_NODENAME
	echo 'export DEF_NODENAME='$DEF_NODENAME >> $HOME/.bash_profile
fi
DEFUND_PORT=40
if [ ! $WALLET ]; then
...
echo '================================================='
echo -e "Your node name: \e[1m\e[32m$DEF_NODENAME\e[0m"
...
# init
defundd init $DEF_NODENAME --chain-id $DEFUND_CHAIN_ID
