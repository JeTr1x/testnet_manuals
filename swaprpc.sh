...
sed -i 's|"rpc": "https://optimism-sepolia.blockpi.network/v1/rpc/6807fa355fdc9325ea697b5d52efeb4d1adf13f9f"|"rpc": "'$CHAINRPC'"|' /root/mee-node-deployment/chains-testnet/11155420.json
