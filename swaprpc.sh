...
sed -ie 's|"rpc": "https://base-sepolia.blockpi.network/v1/rpc/19b755f222187861ca7e009cfd2a3deec41a676e"|"rpc": "'$CHAINRPC'"|' /root/mee-node-deployment/chains-testnet/84532.json
sed -ie 's|"rpc": "https://arbitrum-sepolia.blockpi.network/v1/rpc/39dfe10c6563716d3d3b141908f8789b72bfa5e6"|"rpc": "'$CHAINRPC'"|' /root/mee-node-deployment/chains-testnet/421614.json
sed -ie 's|"rpc": "https://ethereum.blockpi.network/v1/rpc/73bb047999c50700b9890a056d06f87a9df3ba66"|"rpc": "'$L1RPC'"|' /root/mee-node-deployment/chains-testnet/1.json
